...
/*   Updated: 2017/08/21 03:11:38 by mbriffau         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void calculate_the_line(t_3d *d, t_fxy *a, t_fxy *b, int way)
{
	...
	x_line =(way & 1 ? 1 : 0);
	y_line =(way & 2 ? 1 : 0);
	a->x = (d->start_x + (d->x_map  * d->value)) - (d->x_map  * d->angle_x) + (d->y_map * d->angle_y) + d-> decal_x;
	a->y = ((d->start_y + (d->y_map  * d->value)) - (d->x_map  * d->angle_x) + (d->y_map * d->angle_y) - calculate_z(&*d, x_line, y_line, 0)) + d->decal_y;
	b->x = (d->start_x + ((d->x_map + x_line)  * d->value)) - ((d->x_map + x_line)  * d->angle_x) + ((d->y_map + y_line) * d->angle_y) + d-> decal_x;
	b->y = ((d->start_y + ((d->y_map + y_line)  * d->value)) - ((d->x_map + x_line)  * d->angle_x) + ((d->y_map + y_line) * d->angle_y) - calculate_z(&*d, x_line, y_line, 1)) + d->decal_y;
}
